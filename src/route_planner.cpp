...
RouteModel::Node *RoutePlanner::NextNode() {
    std::sort(std::begin(open_list), std::end(open_list),
              [](const RouteModel::Node *l, const RouteModel::Node *r) {
                  return l->g_value + l->h_value < r->g_value + r->h_value;
              });

    auto closest_node = open_list.front();
...
void RoutePlanner::AStarSearch() {
    ...
    // Important thing: make sure that starting node is marked as visited
